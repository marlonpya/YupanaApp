...
import com.strawtechberry.yupana.feature.settings.ui.root.SettingsRootRoute
import kotlinx.coroutines.launch
import org.koin.compose.koinInject

/**
 * Shell con el bottom nav de 4 pestañas (Inicio/Cuentas/Clientes/Ajustes). El estado
 * de pestaña es local (sin NavHost anidado); los formularios de cliente/cuenta, el
 * catálogo de servicios, el detalle de asignación y las subpantallas de Ajustes (Mi
 * cuenta/Preferencias de notificación) navegan de verdad, vía el NavController de nivel
 * superior (callbacks recibidos). El FAB de "Nueva asignación" solo se muestra en la
 * pestaña Inicio.
 */
@Composable
fun MainScaffold(
    ...
    Scaffold(
        // Cada pestaña maneja su propio inset superior (YupanaTopBar/DashboardScreen) y
        // YupanaBottomNav ya maneja el inferior; sin esto el Scaffold reservaría el
        // safeDrawing default además, duplicando el espacio.
