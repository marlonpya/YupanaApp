 ...
 * de pestaña es local (sin NavHost anidado); solo el formulario de cliente navega
 * de verdad, vía el NavController de nivel superior (callbacks recibidos).
 */
@Composable
fun MainScaffold(
    onCerrarSesion: () -> Unit,
